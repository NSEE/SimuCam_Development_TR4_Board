...
begin
    ...
    tx_ftdi_data_buffer_ent_inst : entity work.ftdi_data_buffer_ent
        port map(
            clk_i                 => a_avs_clock,
            rst_i                 => a_reset,
    ...
    rx_ftdi_data_buffer_ent_inst : entity work.ftdi_data_buffer_ent
        port map(
            clk_i                 => a_avs_clock,
            rst_i                 => a_reset,
            double_buffer_clear_i => s_config_write_registers.ftdi_module_control_reg.ftdi_module_clear,
    ...
    ftdi_protocol_top_inst : entity work.ftdi_protocol_top
        port map(
            ...
            ftdi_module_stop_i                     => s_config_write_registers.ftdi_module_control_reg.ftdi_module_stop,
            ftdi_module_start_i                    => s_config_write_registers.ftdi_module_control_reg.ftdi_module_start,
            rx_payload_reader_force_length_bytes_i => s_config_write_registers.payload_config_reg.rx_payload_reader_force_length_bytes,
            rx_payload_reader_qqword_delay_i       => s_config_write_registers.payload_config_reg.rx_payload_reader_qqword_delay,
            tx_payload_writer_qqword_delay_i       => s_config_write_registers.payload_config_reg.tx_payload_writer_qqword_delay,
