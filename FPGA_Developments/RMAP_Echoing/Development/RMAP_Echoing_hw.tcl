...
# 
# connection point conduit_end_rmap_echo_6_in
# 
add_interface conduit_end_rmap_echo_6_in conduit end
set_interface_property conduit_end_rmap_echo_6_in associatedClock clock_sink_100mhz
set_interface_property conduit_end_rmap_echo_6_in associatedReset reset_sink
set_interface_property conduit_end_rmap_echo_6_in ENABLED true
set_interface_property conduit_end_rmap_echo_6_in EXPORT_OF ""
set_interface_property conduit_end_rmap_echo_6_in PORT_NAME_MAP ""
set_interface_property conduit_end_rmap_echo_6_in CMSIS_SVD_VARIABLES ""
set_interface_property conduit_end_rmap_echo_6_in SVD_ADDRESS_GROUP ""

add_interface_port conduit_end_rmap_echo_6_in rmap_echo_6_echo_en_i echo_en_signal Input 1
add_interface_port conduit_end_rmap_echo_6_in rmap_echo_6_echo_id_en_i echo_id_en_signal Input 1
add_interface_port conduit_end_rmap_echo_6_in rmap_echo_6_in_fifo_wrflag_i in_fifo_wrflag_signal Input 1
add_interface_port conduit_end_rmap_echo_6_in rmap_echo_6_in_fifo_wrdata_i in_fifo_wrdata_signal Input 8 
add_interface_port conduit_end_rmap_echo_6_in rmap_echo_6_in_fifo_wrreq_i in_fifo_wrreq_signal Input 1
add_interface_port conduit_end_rmap_echo_6_in rmap_echo_6_out_fifo_wrflag_i out_fifo_wrflag_signal Input 1
add_interface_port conduit_end_rmap_echo_6_in rmap_echo_6_out_fifo_wrdata_i out_fifo_wrdata_signal Input 8 
add_interface_port conduit_end_rmap_echo_6_in rmap_echo_6_out_fifo_wrreq_i out_fifo_wrreq_signal Input 1
