...
// ============================================================
// File Name: avs_byteen_buffer_sc_fifo.v
// Megafunction Name(s):
// 			scfifo
//
...
//scfifo ADD_RAM_OUTPUT_REGISTER="OFF" DEVICE_FAMILY="Stratix IV" LPM_NUMWORDS=2048 LPM_SHOWAHEAD="OFF" LPM_WIDTH=8 LPM_WIDTHU=11 OVERFLOW_CHECKING="ON" UNDERFLOW_CHECKING="ON" USE_EAB="ON" aclr clock data empty full q rdreq sclr usedw wrreq INTENDED_DEVICE_FAMILY="Stratix IV"
...
//a_dpfifo ADD_RAM_OUTPUT_REGISTER="OFF" ALLOW_RWCYCLE_WHEN_FULL="OFF" DEVICE_FAMILY="Stratix IV" LPM_NUMWORDS=2048 LPM_SHOWAHEAD="OFF" lpm_width=8 lpm_widthu=11 OVERFLOW_CHECKING="ON" UNDERFLOW_CHECKING="ON" aclr clock data empty full q rreq sclr usedw wreq INTENDED_DEVICE_FAMILY="Stratix IV"
//VERSION_BEGIN 16.1 cbx_altdpram 2016:10:24:15:04:16:SJ cbx_altera_counter 2016:10:24:15:04:16:SJ cbx_altera_syncram 2016:10:24:15:04:16:SJ cbx_altera_syncram_nd_impl 2016:10:24:15:04:16:SJ cbx_altsyncram 2016:10:24:15:04:16:SJ cbx_cycloneii 2016:10:24:15:04:16:SJ cbx_fifo_common 2016:10:24:15:04:16:SJ cbx_lpm_add_sub 2016:10:24:15:04:16:SJ cbx_lpm_compare 2016:10:24:15:04:16:SJ cbx_lpm_counter 2016:10:24:15:04:16:SJ cbx_lpm_decode 2016:10:24:15:04:16:SJ cbx_lpm_mux 2016:10:24:15:04:16:SJ cbx_mgl 2016:10:24:15:05:03:SJ cbx_nadder 2016:10:24:15:04:16:SJ cbx_scfifo 2016:10:24:15:04:16:SJ cbx_stratix 2016:10:24:15:04:16:SJ cbx_stratixii 2016:10:24:15:04:16:SJ cbx_stratixiii 2016:10:24:15:04:16:SJ cbx_stratixv 2016:10:24:15:04:16:SJ cbx_util_mgl 2016:10:24:15:04:16:SJ  VERSION_END


//a_fefifo ALLOW_RWCYCLE_WHEN_FULL="OFF" LPM_NUMWORDS=2048 lpm_widthad=11 OVERFLOW_CHECKING="ON" UNDERFLOW_CHECKING="ON" aclr clock empty full rreq sclr usedw_out wreq
...
//lpm_counter DEVICE_FAMILY="Stratix IV" lpm_width=11 aclr clock cnt_en q sclr updown
...
module  avs_byteen_buffer_sc_fifo_cntr
	( 
	aclr,
	clock,
	cnt_en,
...
`endif
	...
	wire	[10:0]	wire_counter_reg_bit_d;
	wire	[10:0]	wire_counter_reg_bit_asdata;
	reg	[10:0]	counter_reg_bit;
	wire	[10:0]	wire_counter_reg_bit_ena;
	wire	[10:0]	wire_counter_reg_bit_sload;
...
endmodule //avs_byteen_buffer_sc_fifo_cntr

//synthesis_resources = lut 11 reg 13 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  avs_byteen_buffer_sc_fifo_a_fefifo
	( 
	aclr,
	clock,
	empty,
...
`endif
	...
	always @ ( posedge clock or  posedge aclr)
		...
		else  b_full <= ((b_full & (b_full ^ (sclr | rreq))) | (((~ b_full) & b_non_empty) & ((~ sclr) & ((is_almost_full10 & wreq) & (~ rreq)))));
	// synopsys translate_off
	initial
		b_non_empty = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else  b_non_empty <= (((b_full & (b_full ^ sclr)) | (((~ b_non_empty) & wreq) & (~ sclr))) | (((~ b_full) & b_non_empty) & (((~ b_full) & b_non_empty) ^ (sclr | ((is_almost_empty10 & rreq) & (~ wreq))))));
	avs_byteen_buffer_sc_fifo_cntr   count_usedw
	( 
	.aclr(aclr),
	.clock(clock),
...
endmodule //avs_byteen_buffer_sc_fifo_a_fefifo


//altsyncram ADDRESS_ACLR_A="NONE" ADDRESS_ACLR_B="NONE" ADDRESS_REG_B="CLOCK1" DEVICE_FAMILY="Stratix IV" ENABLE_ECC="FALSE" INDATA_ACLR_A="NONE" NUMWORDS_A=2048 NUMWORDS_B=2048 OPERATION_MODE="DUAL_PORT" OUTDATA_ACLR_B="NONE" OUTDATA_REG_B="UNREGISTERED" RDCONTROL_ACLR_B="NONE" RDCONTROL_REG_B="CLOCK0" READ_DURING_WRITE_MODE_MIXED_PORTS="DONT_CARE" WIDTH_A=8 WIDTH_B=8 WIDTH_ECCSTATUS=2 WIDTHAD_A=11 WIDTHAD_B=11 WRCONTROL_ACLR_A="NONE" address_a address_b clock0 clock1 clocken1 data_a q_b wren_a
...
module  avs_byteen_buffer_sc_fifo_altsyncram
	( 
	address_a,
	address_b,
	clock0,
...
endmodule //avs_byteen_buffer_sc_fifo_altsyncram


//lpm_counter DEVICE_FAMILY="Stratix IV" lpm_direction="UP" lpm_port_updown="PORT_UNUSED" lpm_width=11 aclr clock cnt_en q sclr
//VERSION_BEGIN 16.1 cbx_cycloneii 2016:10:24:15:04:16:SJ cbx_lpm_add_sub 2016:10:24:15:04:16:SJ cbx_lpm_compare 2016:10:24:15:04:16:SJ cbx_lpm_counter 2016:10:24:15:04:16:SJ cbx_lpm_decode 2016:10:24:15:04:16:SJ cbx_mgl 2016:10:24:15:05:03:SJ cbx_nadder 2016:10:24:15:04:16:SJ cbx_stratix 2016:10:24:15:04:16:SJ cbx_stratixii 2016:10:24:15:04:16:SJ  VERSION_END
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  avs_byteen_buffer_sc_fifo_cntr1
	( 
	aclr,
	clock,
	cnt_en,
...
`endif
	...
	assign
		...
		updown_lsb = updown_dir,
		updown_other_bits = ((~ external_cin) | updown_dir);
endmodule //avs_byteen_buffer_sc_fifo_cntr1

//synthesis_resources = lut 33 ram_bits (AUTO) 16384 reg 35 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  avs_byteen_buffer_sc_fifo_a_dpfifo
	( 
	aclr,
	clock,
	data,
...
`endif
	...
	wire  [10:0]   wire_fifo_state_usedw_out;
	wire  [7:0]   wire_FIFOram_q_b;
	wire  [10:0]   wire_rd_ptr_count_q;
	wire  [10:0]   wire_wr_ptr_q;
	wire  [10:0]  rd_ptr;
	wire  valid_rreq;
	wire  valid_wreq;

	avs_byteen_buffer_sc_fifo_a_fefifo   fifo_state
	( 
	.aclr(aclr),
	.clock(clock),
	...
	.wreq(wreq));
	avs_byteen_buffer_sc_fifo_altsyncram   FIFOram
	( 
	.address_a(wire_wr_ptr_q),
	.address_b(({11{(~ sclr)}} & rd_ptr)),
	.clock0(clock),
	.clock1(clock),
	...
	.wren_a(valid_wreq));
	avs_byteen_buffer_sc_fifo_cntr1   rd_ptr_count
	( 
	.aclr(aclr),
	.clock(clock),
	.cnt_en(valid_rreq),
	...
	.sclr(sclr));
	avs_byteen_buffer_sc_fifo_cntr1   wr_ptr
	( 
	.aclr(aclr),
	.clock(clock),
	.cnt_en(valid_wreq),
...
endmodule //avs_byteen_buffer_sc_fifo_a_dpfifo

//synthesis_resources = lut 33 ram_bits (AUTO) 16384 reg 35 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  avs_byteen_buffer_sc_fifo_scfifo
	( 
	aclr,
	clock,
	data,
...
`endif
	...
	wire  [10:0]   wire_dpfifo_usedw;

	avs_byteen_buffer_sc_fifo_a_dpfifo   dpfifo
	( 
	.aclr(aclr),
	.clock(clock),
	.data(data),
	...
	assign
		...
		q = wire_dpfifo_q,
		usedw = wire_dpfifo_usedw;
endmodule //avs_byteen_buffer_sc_fifo_scfifo
//VALID FILE
...
`timescale 1 ps / 1 ps
// synopsys translate_on
module avs_byteen_buffer_sc_fifo (
	aclr,
	clock,
	data,
	rdreq,
	...
	avs_byteen_buffer_sc_fifo_scfifo	avs_byteen_buffer_sc_fifo_scfifo_component (
				.aclr (aclr),
				.clock (clock),
				.data (data),
				.rdreq (rdreq),
