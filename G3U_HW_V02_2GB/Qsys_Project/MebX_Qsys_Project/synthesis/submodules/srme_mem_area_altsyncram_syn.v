...
// ============================================================
// File Name: srme_mem_area_altsyncram.v
// Megafunction Name(s):
// 			altsyncram
//
...
//altsyncram CLOCK_ENABLE_INPUT_A="BYPASS" CLOCK_ENABLE_OUTPUT_A="BYPASS" DEVICE_FAMILY="Stratix IV" ENABLE_RUNTIME_MOD="NO" NUMWORDS_A=4096 OPERATION_MODE="SINGLE_PORT" OUTDATA_ACLR_A="CLEAR0" OUTDATA_REG_A="CLOCK0" POWER_UP_UNINITIALIZED="TRUE" RAM_BLOCK_TYPE="M9K" read_during_write_mode_port_a="DONT_CARE" WIDTH_A=8 WIDTH_BYTEENA_A=1 WIDTHAD_A=12 aclr0 address_a clock0 data_a q_a wren_a
...
module  srme_mem_area_altsyncram_altsyncram
	( 
	aclr0,
	address_a,
	clock0,
...
endmodule //srme_mem_area_altsyncram_altsyncram
//VALID FILE
...
`timescale 1 ps / 1 ps
// synopsys translate_on
module srme_mem_area_altsyncram (
	aclr,
	address,
	clock,
	data,
...
`endif
	...
	srme_mem_area_altsyncram_altsyncram	srme_mem_area_altsyncram_altsyncram_component (
				.aclr0 (aclr),
				.address_a (address),
				.clock0 (clock),
				.data_a (data),
