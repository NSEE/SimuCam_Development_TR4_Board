...
// ============================================================
// File Name: spwc_timecode_dc_fifo.v
// Megafunction Name(s):
// 			dcfifo
//
...
//a_gray2bin device_family="Stratix IV" WIDTH=3 bin gray
...
module  spwc_timecode_dc_fifo_a_gray2bin
	( 
	bin,
	...
	assign
		...
		xor0 = (gray[0] ^ xor1),
		xor1 = (gray[2] ^ gray[1]);
endmodule //spwc_timecode_dc_fifo_a_gray2bin


//a_graycounter DEVICE_FAMILY="Stratix IV" PVALUE=1 WIDTH=3 aclr clock cnt_en q
...
module  spwc_timecode_dc_fifo_a_graycounter
	( 
	aclr,
	clock,
	cnt_en,
...
`endif
	...
	assign
		...
		sclr = 1'b0,
		updown = 1'b1;
endmodule //spwc_timecode_dc_fifo_a_graycounter


//a_graycounter DEVICE_FAMILY="Stratix IV" PVALUE=1 WIDTH=3 aclr clock cnt_en q ALTERA_INTERNAL_OPTIONS=suppress_da_rule_internal=S102
//VERSION_BEGIN 18.1 cbx_a_gray2bin 2018:09:12:13:04:24:SJ cbx_a_graycounter 2018:09:12:13:04:24:SJ cbx_cycloneii 2018:09:12:13:04:24:SJ cbx_mgl 2018:09:12:13:10:36:SJ cbx_stratix 2018:09:12:13:04:24:SJ cbx_stratixii 2018:09:12:13:04:24:SJ  VERSION_END
...
module  spwc_timecode_dc_fifo_a_graycounter1
	( 
	aclr,
	clock,
	cnt_en,
...
//altdpram DEVICE_FAMILY="Stratix IV" INDATA_ACLR="OFF" INTENDED_DEVICE_FAMILY="Stratix IV" lpm_hint="RAM_BLOCK_TYPE=MLAB" OUTDATA_REG="UNREGISTERED" RAM_BLOCK_TYPE="MLAB" RDADDRESS_REG="UNREGISTERED" USE_EAB="ON" WIDTH=8 WIDTHAD=2 WRADDRESS_REG="INCLOCK" data inclock outclock q rdaddress wraddress wren
...
module  spwc_timecode_dc_fifo_dpram
	( 
	data,
	inclock,
	outclock,
...
`endif
	...
	wire  [1:0]  rdaddr_wire;
	wire  wr_en;
	wire  [1:0]  wraddr_wire;
	...
	.clk0(inclock),
	.ena0(wr_en),
	.portaaddr(wraddr_wire[1:0]),
	.portadatain(datain_wire[0]),
	.portbaddr(rdaddr_wire[1:0]),
	...
	defparam
		lutrama_0.address_width = 2,
		lutrama_0.data_width = 1,
		lutrama_0.first_address = 0,
		lutrama_0.first_bit_number = 0,
		lutrama_0.last_address = 3,
		lutrama_0.logical_ram_depth = 4,
	...
	defparam
		lutrama_1.address_width = 2,
		lutrama_1.data_width = 1,
		lutrama_1.first_address = 0,
		lutrama_1.first_bit_number = 1,
		lutrama_1.last_address = 3,
		lutrama_1.logical_ram_depth = 4,
	...
	defparam
		lutrama_2.address_width = 2,
		lutrama_2.data_width = 1,
		lutrama_2.first_address = 0,
		lutrama_2.first_bit_number = 2,
		lutrama_2.last_address = 3,
		lutrama_2.logical_ram_depth = 4,
	...
	defparam
		lutrama_3.address_width = 2,
		lutrama_3.data_width = 1,
		lutrama_3.first_address = 0,
		lutrama_3.first_bit_number = 3,
		lutrama_3.last_address = 3,
		lutrama_3.logical_ram_depth = 4,
	...
	defparam
		lutrama_4.address_width = 2,
		lutrama_4.data_width = 1,
		lutrama_4.first_address = 0,
		lutrama_4.first_bit_number = 4,
		lutrama_4.last_address = 3,
		lutrama_4.logical_ram_depth = 4,
	...
	defparam
		lutrama_5.address_width = 2,
		lutrama_5.data_width = 1,
		lutrama_5.first_address = 0,
		lutrama_5.first_bit_number = 5,
		lutrama_5.last_address = 3,
		lutrama_5.logical_ram_depth = 4,
	...
	defparam
		lutrama_6.address_width = 2,
		lutrama_6.data_width = 1,
		lutrama_6.first_address = 0,
		lutrama_6.first_bit_number = 6,
		lutrama_6.last_address = 3,
		lutrama_6.logical_ram_depth = 4,
	...
	defparam
		lutrama_7.address_width = 2,
		lutrama_7.data_width = 1,
		lutrama_7.first_address = 0,
		lutrama_7.first_bit_number = 7,
		lutrama_7.last_address = 3,
		lutrama_7.logical_ram_depth = 4,
...
endmodule //spwc_timecode_dc_fifo_dpram
...
module  spwc_timecode_dc_fifo_dffpipe
	( 
	clock,
	clrn,
	d,
...
`endif
	...
	assign
		...
		q = dffe10a,
		sclr = 1'b0;
endmodule //spwc_timecode_dc_fifo_dffpipe
...
module  spwc_timecode_dc_fifo_dffpipe1
	( 
	clock,
	clrn,
	d,
...
`endif
	...
	assign
		...
		q = dffe11a,
		sclr = 1'b0;
endmodule //spwc_timecode_dc_fifo_dffpipe1
...
//synopsys translate_on
(* ALTERA_ATTRIBUTE = {"AUTO_SHIFT_REGISTER_RECOGNITION=OFF"} *)
module  spwc_timecode_dc_fifo_dffpipe12
	( 
	clock,
	clrn,
	d,
...
`endif
	...
	// synopsys translate_on
	always @ ( posedge clock or  negedge prn or  negedge clrn)
		if (prn == 1'b0) dffe13a <= {3{1'b1}};
		else if (clrn == 1'b0) dffe13a <= 3'b0;
		else if  (ena == 1'b1)   dffe13a <= (d & {3{(~ sclr)}});
	// synopsys translate_off
	initial
		dffe14a = 0;
	// synopsys translate_on
	always @ ( posedge clock or  negedge prn or  negedge clrn)
		if (prn == 1'b0) dffe14a <= {3{1'b1}};
		else if (clrn == 1'b0) dffe14a <= 3'b0;
		else if  (ena == 1'b1)   dffe14a <= (dffe13a & {3{(~ sclr)}});
	assign
		ena = 1'b1,
		prn = 1'b1,
		q = dffe14a,
		sclr = 1'b0;
endmodule //spwc_timecode_dc_fifo_dffpipe12
...
module  spwc_timecode_dc_fifo_alt_synch_pipe
	( 
	clock,
	clrn,
	d,
...
`endif
	...
	wire  [2:0]   wire_dffpipe12_q;

	spwc_timecode_dc_fifo_dffpipe12   dffpipe12
	( 
	.clock(clock),
	.clrn(clrn),
	.d(d),
	...
	assign
		q = wire_dffpipe12_q;
endmodule //spwc_timecode_dc_fifo_alt_synch_pipe
...
//synopsys translate_on
(* ALTERA_ATTRIBUTE = {"AUTO_SHIFT_REGISTER_RECOGNITION=OFF"} *)
module  spwc_timecode_dc_fifo_dffpipe123
	( 
	clock,
	clrn,
	d,
...
`endif
	...
	// synopsys translate_on
	always @ ( posedge clock or  negedge prn or  negedge clrn)
		if (prn == 1'b0) dffe16a <= {3{1'b1}};
		else if (clrn == 1'b0) dffe16a <= 3'b0;
		else if  (ena == 1'b1)   dffe16a <= (d & {3{(~ sclr)}});
	// synopsys translate_off
	initial
		dffe17a = 0;
	// synopsys translate_on
	always @ ( posedge clock or  negedge prn or  negedge clrn)
		...
		else if  (ena == 1'b1)   dffe17a <= (dffe16a & {3{(~ sclr)}});
	assign
		ena = 1'b1,
		prn = 1'b1,
		q = dffe17a,
		sclr = 1'b0;
endmodule //spwc_timecode_dc_fifo_dffpipe123
...
//synopsys translate_on
(* ALTERA_ATTRIBUTE = {"X_ON_VIOLATION_OPTION=OFF;SYNCHRONIZER_IDENTIFICATION=FORCED_IF_ASYNCHRONOUS;PRESERVE_REGISTER=ON;DONT_MERGE_REGISTER=ON;ADV_NETLIST_OPT_ALLOWED=NEVER_ALLOW"} *)
module  spwc_timecode_dc_fifo_alt_synch_pipe1
	( 
	clock,
	clrn,
	d,
...
`endif
	...
	wire  [2:0]   wire_dffpipe15_q;

	spwc_timecode_dc_fifo_dffpipe123   dffpipe15
	( 
	.clock(clock),
	.clrn(clrn),
	.d(d),
	...
	assign
		q = wire_dffpipe15_q;
endmodule //spwc_timecode_dc_fifo_alt_synch_pipe1


//lpm_add_sub DEVICE_FAMILY="Stratix IV" LPM_DIRECTION="SUB" LPM_WIDTH=3 dataa datab result
...
//lpm_compare DEVICE_FAMILY="Stratix IV" LPM_WIDTH=3 aeb dataa datab
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  spwc_timecode_dc_fifo_cmpr
	( 
	aeb,
	dataa,
...
endmodule //spwc_timecode_dc_fifo_cmpr

//synthesis_resources = lut 8 MLAB 1 reg 56 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
(* ALTERA_ATTRIBUTE = {"AUTO_SHIFT_REGISTER_RECOGNITION=OFF;REMOVE_DUPLICATE_REGISTERS=OFF;SYNCHRONIZER_IDENTIFICATION=OFF;SYNCHRONIZATION_REGISTER_CHAIN_LENGTH = 2;suppress_da_rule_internal=d101;suppress_da_rule_internal=d102;suppress_da_rule_internal=d103;suppress_da_rule_internal=R105;-name CUT ON -from rdptr_g -to ws_dgrp|spwc_timecode_dc_fifo_dffpipe123:dffpipe15|dffe16a;-name SDC_STATEMENT \"set_false_path -from *rdptr_g* -to *ws_dgrp|spwc_timecode_dc_fifo_dffpipe123:dffpipe15|dffe16a* \";-name CUT ON -from delayed_wrptr_g -to rs_dgwp|spwc_timecode_dc_fifo_dffpipe12:dffpipe12|dffe13a;-name SDC_STATEMENT \"set_false_path -from *delayed_wrptr_g* -to *rs_dgwp|spwc_timecode_dc_fifo_dffpipe12:dffpipe12|dffe13a* \""} *)
module  spwc_timecode_dc_fifo_dcfifo
	( 
	aclr,
	data,
	q,
...
`endif
	...
	wire  [2:0]   wire_rs_brp_q;
	wire  [2:0]   wire_rs_bwp_q;
	wire  [2:0]   wire_rs_dgwp_q;
	wire  [0:0]   wire_wraclr_q;
	wire  [2:0]   wire_ws_brp_q;
	wire  [2:0]   wire_ws_bwp_q;
	wire  [2:0]   wire_ws_dgrp_q;
	wire	[2:0]	wire_rdusedw_sub_dataa;
	wire	[2:0]	wire_rdusedw_sub_datab;
	wire	[2:0]	wire_rdusedw_sub_result;
	...
	wire  int_rdempty;
	wire  int_wrfull;
	wire  [1:0]  ram_rdaddress;
	wire  [1:0]  ram_wraddress;
	wire  [0:0]  temp_read;
	wire  valid_rdreq;
	wire  valid_wrreq;
	wire  [2:0]  wrptr_gs;

	spwc_timecode_dc_fifo_a_gray2bin   rdptr_g_gray2bin
	( 
	.bin(wire_rdptr_g_gray2bin_bin),
	.gray(rdptr_g[2:0]));
	spwc_timecode_dc_fifo_a_gray2bin   rs_dgwp_gray2bin
	( 
	.bin(wire_rs_dgwp_gray2bin_bin),
	.gray(wire_rs_dgwp_q[2:0]));
	spwc_timecode_dc_fifo_a_gray2bin   wrptr_g_gray2bin
	( 
	.bin(wire_wrptr_g_gray2bin_bin),
	.gray(wrptr_g[2:0]));
	spwc_timecode_dc_fifo_a_gray2bin   ws_dgrp_gray2bin
	( 
	.bin(wire_ws_dgrp_gray2bin_bin),
	.gray(wire_ws_dgrp_q[2:0]));
	spwc_timecode_dc_fifo_a_graycounter   rdptr_g1p
	( 
	.aclr((~ wire_rdaclr_q)),
	.clock(rdclk),
	.cnt_en(valid_rdreq),
	.q(wire_rdptr_g1p_q));
	spwc_timecode_dc_fifo_a_graycounter1   wrptr_g1p
	( 
	.aclr((~ wire_wraclr_q)),
	.clock(wrclk),
	.cnt_en(valid_wrreq),
	.q(wire_wrptr_g1p_q));
	spwc_timecode_dc_fifo_dpram   fifo_lutram
	( 
	.data(data),
	.inclock(wrclk),
	.outclock(rdclk),
	...
	always @ ( posedge rdclk or  negedge wire_rdaclr_q)
		if (wire_rdaclr_q == 1'b0) rdptr_g <= 3'b0;
	...
	spwc_timecode_dc_fifo_dffpipe   rdaclr
	( 
	.clock(rdclk),
	.clrn((~ aclr)),
	.d(1'b1),
	.q(wire_rdaclr_q));
	spwc_timecode_dc_fifo_dffpipe1   rs_brp
	( 
	.clock(rdclk),
	.clrn(wire_rdaclr_q),
	.d(wire_rdptr_g_gray2bin_bin),
	.q(wire_rs_brp_q));
	spwc_timecode_dc_fifo_dffpipe1   rs_bwp
	( 
	.clock(rdclk),
	.clrn(wire_rdaclr_q),
	.d(wire_rs_dgwp_gray2bin_bin),
	.q(wire_rs_bwp_q));
	spwc_timecode_dc_fifo_alt_synch_pipe   rs_dgwp
	( 
	.clock(rdclk),
	.clrn(wire_rdaclr_q),
	.d(delayed_wrptr_g),
	.q(wire_rs_dgwp_q));
	spwc_timecode_dc_fifo_dffpipe   wraclr
	( 
	.clock(wrclk),
	.clrn((~ aclr)),
	.d(1'b1),
	.q(wire_wraclr_q));
	spwc_timecode_dc_fifo_dffpipe1   ws_brp
	( 
	.clock(wrclk),
	.clrn(wire_wraclr_q),
	.d(wire_ws_dgrp_gray2bin_bin),
	.q(wire_ws_brp_q));
	spwc_timecode_dc_fifo_dffpipe1   ws_bwp
	( 
	.clock(wrclk),
	.clrn(wire_wraclr_q),
	.d(wire_wrptr_g_gray2bin_bin),
	.q(wire_ws_bwp_q));
	spwc_timecode_dc_fifo_alt_synch_pipe1   ws_dgrp
	( 
	.clock(wrclk),
	.clrn(wire_wraclr_q),
	.d(rdptr_g),
	...
	spwc_timecode_dc_fifo_cmpr   rdempty_eq_comp
	( 
	.aeb(wire_rdempty_eq_comp_aeb),
	.dataa(wire_rs_dgwp_q),
	.datab(rdptr_g));
	spwc_timecode_dc_fifo_cmpr   wrfull_eq_comp
	( 
	...
	assign
		...
		q = wire_fifo_lutram_q,
		ram_rdaddress = {rdptr_g1p_dffe, rdptr_g[0]},
		ram_wraddress = {(wrptr_g[2] ^ wrptr_g[1]), wrptr_g[0]},
		rdempty = int_rdempty,
		rdusedw = {wire_rdusedw_sub_result[1:0]},
		temp_read = (wire_rdptr_g1p_q[2] ^ wire_rdptr_g1p_q[1]),
...
endmodule //spwc_timecode_dc_fifo_dcfifo
//VALID FILE
...
`endif
	...
	wire [1:0] wrusedw = sub_wire4[1:0];

	spwc_timecode_dc_fifo_dcfifo	spwc_timecode_dc_fifo_dcfifo_component (
				.aclr (aclr),
				.data (data),
				.rdclk (rdclk),
				.rdreq (rdreq),
