...
// ============================================================
// File Name: windowing_mask_sc_fifo.v
// Megafunction Name(s):
// 			scfifo
//
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  windowing_mask_sc_fifo_cmpr
	( 
	aeb,
	dataa,
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  windowing_mask_sc_fifo_cntr
	( 
	aclr,
	clock,
	cnt_en,
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  windowing_mask_sc_fifo_cntr1
	( 
	aclr,
	clock,
	cnt_en,
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  windowing_mask_sc_fifo_cntr12
	( 
	aclr,
	clock,
	cnt_en,
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  windowing_mask_sc_fifo_a_dpfifo
	( 
	aclr,
	clock,
	data,
...
`endif
	...
	windowing_mask_sc_fifo_altsyncram   FIFOram
	( 
	...
	.q(wire_rd_ptr_msb_q),
	.sclr(sclr));
	windowing_mask_sc_fifo_cntr1   usedw_counter
	( 
	.aclr(aclr),
	.clock(clock),
	...
	.sclr(sclr),
	.updown(valid_wreq));
	windowing_mask_sc_fifo_cntr12   wr_ptr
	( 
	.aclr(aclr),
	.clock(clock),
	.cnt_en(valid_wreq),
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  windowing_mask_sc_fifo_scfifo
	( 
	aclr,
	clock,
	data,
...
`endif
	...
	assign
		...
		q = wire_dpfifo_q,
		usedw = wire_dpfifo_usedw;
endmodule //windowing_mask_sc_fifo_scfifo
//VALID FILE
