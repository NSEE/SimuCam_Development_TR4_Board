...
// ============================================================
// File Name: spwc_command_dc_fifo.v
// Megafunction Name(s):
// 			dcfifo
//
...
module  spwc_command_dc_fifo_a_gray2bin
	( 
	bin,
	...
	assign
		...
		xor1 = (gray[1] ^ xor2),
		xor2 = (gray[3] ^ gray[2]);
endmodule //spwc_command_dc_fifo_a_gray2bin
...
module  spwc_command_dc_fifo_a_graycounter
	( 
	aclr,
	clock,
	cnt_en,
...
`endif
	...
	assign
		...
		sclr = 1'b0,
		updown = 1'b1;
endmodule //spwc_command_dc_fifo_a_graycounter
...
module  spwc_command_dc_fifo_a_graycounter1
	( 
	aclr,
	clock,
	cnt_en,
...
`endif
	...
	assign
		...
		sclr = 1'b0,
		updown = 1'b1;
endmodule //spwc_command_dc_fifo_a_graycounter1


//altdpram DEVICE_FAMILY="Stratix IV" INDATA_ACLR="OFF" INTENDED_DEVICE_FAMILY="Stratix IV" lpm_hint="RAM_BLOCK_TYPE=MLAB" OUTDATA_REG="UNREGISTERED" RAM_BLOCK_TYPE="MLAB" RDADDRESS_REG="UNREGISTERED" USE_EAB="ON" WIDTH=11 WIDTHAD=3 WRADDRESS_REG="INCLOCK" data inclock outclock q rdaddress wraddress wren
...
//synthesis_resources = MLAB 1 reg 14 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
(* ALTERA_ATTRIBUTE = {"ADV_NETLIST_OPT_ALLOWED=\"NEVER_ALLOW\""} *)
module  spwc_command_dc_fifo_dpram
	( 
	data,
	inclock,
	outclock,
...
`endif
	...
	reg	[2:0]	wraddr_reg;
	wire  [10:0]   wire_lutrama_portbdataout;
	wire  [10:0]  datain_wire;
	...
	defparam
		...
		lutrama_0.logical_ram_width = 11,
	...
	defparam
		...
		lutrama_1.logical_ram_width = 11,
	...
	defparam
		...
		lutrama_2.logical_ram_width = 11,
	...
	defparam
		...
		lutrama_3.logical_ram_width = 11,
	...
	defparam
		...
		lutrama_4.logical_ram_width = 11,
	...
	defparam
		...
		lutrama_5.logical_ram_width = 11,
	...
	defparam
		...
		lutrama_6.logical_ram_width = 11,
...
endmodule //spwc_command_dc_fifo_dpram
...
module  spwc_command_dc_fifo_dffpipe
	( 
	clock,
	clrn,
	d,
...
`endif
	...
	assign
		...
		q = dffe10a,
		sclr = 1'b0;
endmodule //spwc_command_dc_fifo_dffpipe
...
module  spwc_command_dc_fifo_dffpipe1
	( 
	clock,
	clrn,
	d,
...
`endif
	...
	assign
		...
		q = dffe11a,
		sclr = 1'b0;
endmodule //spwc_command_dc_fifo_dffpipe1
...
//synopsys translate_on
(* ALTERA_ATTRIBUTE = {"AUTO_SHIFT_REGISTER_RECOGNITION=OFF"} *)
module  spwc_command_dc_fifo_dffpipe12
	( 
	clock,
	clrn,
	d,
...
`endif
	...
	assign
		...
		q = dffe14a,
		sclr = 1'b0;
endmodule //spwc_command_dc_fifo_dffpipe12
...
module  spwc_command_dc_fifo_alt_synch_pipe
	( 
	clock,
	clrn,
	d,
...
`endif
	...
	spwc_command_dc_fifo_dffpipe12   dffpipe12
	( 
	.clock(clock),
	.clrn(clrn),
	.d(d),
	...
	assign
		q = wire_dffpipe12_q;
endmodule //spwc_command_dc_fifo_alt_synch_pipe
...
//synopsys translate_on
(* ALTERA_ATTRIBUTE = {"AUTO_SHIFT_REGISTER_RECOGNITION=OFF"} *)
module  spwc_command_dc_fifo_dffpipe123
	( 
	clock,
	clrn,
	d,
...
`endif
	...
	assign
		...
		q = dffe17a,
		sclr = 1'b0;
endmodule //spwc_command_dc_fifo_dffpipe123
...
//synopsys translate_on
(* ALTERA_ATTRIBUTE = {"X_ON_VIOLATION_OPTION=OFF;SYNCHRONIZER_IDENTIFICATION=FORCED_IF_ASYNCHRONOUS;PRESERVE_REGISTER=ON;DONT_MERGE_REGISTER=ON;ADV_NETLIST_OPT_ALLOWED=NEVER_ALLOW"} *)
module  spwc_command_dc_fifo_alt_synch_pipe1
	( 
	clock,
	clrn,
	d,
...
`endif
	...
	spwc_command_dc_fifo_dffpipe123   dffpipe15
	( 
	.clock(clock),
	.clrn(clrn),
	.d(d),
	...
	assign
		q = wire_dffpipe15_q;
endmodule //spwc_command_dc_fifo_alt_synch_pipe1
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  spwc_command_dc_fifo_cmpr
	( 
	aeb,
	dataa,
...
endmodule //spwc_command_dc_fifo_cmpr

//synthesis_resources = lut 10 MLAB 1 reg 73 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
(* ALTERA_ATTRIBUTE = {"AUTO_SHIFT_REGISTER_RECOGNITION=OFF;REMOVE_DUPLICATE_REGISTERS=OFF;SYNCHRONIZER_IDENTIFICATION=OFF;SYNCHRONIZATION_REGISTER_CHAIN_LENGTH = 2;suppress_da_rule_internal=d101;suppress_da_rule_internal=d102;suppress_da_rule_internal=d103;suppress_da_rule_internal=R105;-name CUT ON -from rdptr_g -to ws_dgrp|spwc_command_dc_fifo_dffpipe123:dffpipe15|dffe16a;-name SDC_STATEMENT \"set_false_path -from *rdptr_g* -to *ws_dgrp|spwc_command_dc_fifo_dffpipe123:dffpipe15|dffe16a* \";-name CUT ON -from delayed_wrptr_g -to rs_dgwp|spwc_command_dc_fifo_dffpipe12:dffpipe12|dffe13a;-name SDC_STATEMENT \"set_false_path -from *delayed_wrptr_g* -to *rs_dgwp|spwc_command_dc_fifo_dffpipe12:dffpipe12|dffe13a* \""} *)
module  spwc_command_dc_fifo_dcfifo
	( 
	aclr,
	data,
	q,
...
`endif
	...
	spwc_command_dc_fifo_a_gray2bin   rdptr_g_gray2bin
	( 
	.bin(wire_rdptr_g_gray2bin_bin),
	.gray(rdptr_g[3:0]));
	spwc_command_dc_fifo_a_gray2bin   rs_dgwp_gray2bin
	( 
	.bin(wire_rs_dgwp_gray2bin_bin),
	.gray(wire_rs_dgwp_q[3:0]));
	spwc_command_dc_fifo_a_gray2bin   wrptr_g_gray2bin
	( 
	.bin(wire_wrptr_g_gray2bin_bin),
	.gray(wrptr_g[3:0]));
	spwc_command_dc_fifo_a_gray2bin   ws_dgrp_gray2bin
	( 
	.bin(wire_ws_dgrp_gray2bin_bin),
	.gray(wire_ws_dgrp_q[3:0]));
	spwc_command_dc_fifo_a_graycounter   rdptr_g1p
	( 
	.aclr((~ wire_rdaclr_q)),
	.clock(rdclk),
	.cnt_en(valid_rdreq),
	.q(wire_rdptr_g1p_q));
	spwc_command_dc_fifo_a_graycounter1   wrptr_g1p
	( 
	.aclr((~ wire_wraclr_q)),
	.clock(wrclk),
	.cnt_en(valid_wrreq),
	.q(wire_wrptr_g1p_q));
	spwc_command_dc_fifo_dpram   fifo_lutram
	( 
	.data(data),
	.inclock(wrclk),
	.outclock(rdclk),
	...
	spwc_command_dc_fifo_dffpipe   rdaclr
	( 
	.clock(rdclk),
	.clrn((~ aclr)),
	.d(1'b1),
	.q(wire_rdaclr_q));
	spwc_command_dc_fifo_dffpipe1   rs_brp
	( 
	.clock(rdclk),
	.clrn(wire_rdaclr_q),
	.d(wire_rdptr_g_gray2bin_bin),
	.q(wire_rs_brp_q));
	spwc_command_dc_fifo_dffpipe1   rs_bwp
	( 
	.clock(rdclk),
	.clrn(wire_rdaclr_q),
	.d(wire_rs_dgwp_gray2bin_bin),
	.q(wire_rs_bwp_q));
	spwc_command_dc_fifo_alt_synch_pipe   rs_dgwp
	( 
	.clock(rdclk),
	.clrn(wire_rdaclr_q),
	.d(delayed_wrptr_g),
	.q(wire_rs_dgwp_q));
	spwc_command_dc_fifo_dffpipe   wraclr
	( 
	.clock(wrclk),
	.clrn((~ aclr)),
	.d(1'b1),
	.q(wire_wraclr_q));
	spwc_command_dc_fifo_dffpipe1   ws_brp
	( 
	.clock(wrclk),
	.clrn(wire_wraclr_q),
	.d(wire_ws_dgrp_gray2bin_bin),
	.q(wire_ws_brp_q));
	spwc_command_dc_fifo_dffpipe1   ws_bwp
	( 
	.clock(wrclk),
	.clrn(wire_wraclr_q),
	.d(wire_wrptr_g_gray2bin_bin),
	.q(wire_ws_bwp_q));
	spwc_command_dc_fifo_alt_synch_pipe1   ws_dgrp
	( 
	.clock(wrclk),
	.clrn(wire_wraclr_q),
	.d(rdptr_g),
	...
	spwc_command_dc_fifo_cmpr   rdempty_eq_comp
	( 
	.aeb(wire_rdempty_eq_comp_aeb),
	.dataa(wire_rs_dgwp_q),
	.datab(rdptr_g));
	spwc_command_dc_fifo_cmpr   wrfull_eq_comp
	( 
...
endmodule //spwc_command_dc_fifo_dcfifo
//VALID FILE
...
`endif
	...
	spwc_command_dc_fifo_dcfifo	spwc_command_dc_fifo_dcfifo_component (
				.aclr (aclr),
				.data (data),
				.rdclk (rdclk),
				.rdreq (rdreq),
