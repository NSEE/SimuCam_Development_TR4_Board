...
// ============================================================
// File Name: data_buffer_sc_fifo.v
// Megafunction Name(s):
// 			scfifo
//
...
module  data_buffer_sc_fifo_altsyncram
	( 
	address_a,
	address_b,
	clock0,
...
endmodule //data_buffer_sc_fifo_altsyncram
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  data_buffer_sc_fifo_cmpr
	( 
	aeb,
	dataa,
...
endmodule //data_buffer_sc_fifo_cmpr
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  data_buffer_sc_fifo_cntr
	( 
	aclr,
	clock,
	cnt_en,
...
endmodule //data_buffer_sc_fifo_cntr
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  data_buffer_sc_fifo_cntr1
	( 
	aclr,
	clock,
	cnt_en,
...
`endif
	...
	assign
		...
		updown_lsb = updown_dir,
		updown_other_bits = ((~ external_cin) | updown_dir);
endmodule //data_buffer_sc_fifo_cntr1
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  data_buffer_sc_fifo_cntr12
	( 
	aclr,
	clock,
	cnt_en,
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  data_buffer_sc_fifo_a_dpfifo
	( 
	aclr,
	clock,
	data,
...
`endif
	...
	data_buffer_sc_fifo_altsyncram   FIFOram
	( 
	...
	data_buffer_sc_fifo_cmpr   almost_full_comparer
	( 
	.aeb(wire_almost_full_comparer_aeb),
	.dataa({5{1'b1}}),
	.datab(wire_usedw_counter_q));
	data_buffer_sc_fifo_cmpr   two_comparison
	( 
	.aeb(wire_two_comparison_aeb),
	.dataa(wire_usedw_counter_q),
	.datab({{3{1'b0}}, 1'b1, 1'b0}));
	data_buffer_sc_fifo_cntr   rd_ptr_msb
	( 
	.aclr(aclr),
	.clock(clock),
	...
	.q(wire_rd_ptr_msb_q),
	.sclr(sclr));
	data_buffer_sc_fifo_cntr1   usedw_counter
	( 
	.aclr(aclr),
	.clock(clock),
	...
	.sclr(sclr),
	.updown(valid_wreq));
	data_buffer_sc_fifo_cntr12   wr_ptr
	( 
	.aclr(aclr),
	.clock(clock),
	.cnt_en(valid_wreq),
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  data_buffer_sc_fifo_scfifo
	( 
	aclr,
	clock,
	data,
...
`endif
	...
	data_buffer_sc_fifo_a_dpfifo   dpfifo
	( 
	.aclr(aclr),
	.clock(clock),
	.data(data),
	...
	assign
		...
		q = wire_dpfifo_q,
		usedw = wire_dpfifo_usedw;
endmodule //data_buffer_sc_fifo_scfifo
//VALID FILE
...
module data_buffer_sc_fifo (
	...
	data_buffer_sc_fifo_scfifo	data_buffer_sc_fifo_scfifo_component (
				.aclr (aclr),
				.clock (clock),
				.data (data),
				.rdreq (rdreq),
