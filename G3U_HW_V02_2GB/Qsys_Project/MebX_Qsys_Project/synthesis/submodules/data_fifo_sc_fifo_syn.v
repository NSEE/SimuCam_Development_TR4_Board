...
//scfifo ADD_RAM_OUTPUT_REGISTER="ON" DEVICE_FAMILY="Stratix IV" LPM_NUMWORDS=32768 LPM_SHOWAHEAD="ON" LPM_WIDTH=8 LPM_WIDTHU=15 OVERFLOW_CHECKING="ON" UNDERFLOW_CHECKING="ON" USE_EAB="ON" aclr clock data empty full q rdreq sclr usedw wrreq INTENDED_DEVICE_FAMILY="Stratix IV"
...
//a_dpfifo ADD_RAM_OUTPUT_REGISTER="ON" ALLOW_RWCYCLE_WHEN_FULL="OFF" DEVICE_FAMILY="Stratix IV" LPM_NUMWORDS=32768 LPM_SHOWAHEAD="ON" lpm_width=8 lpm_widthu=15 OVERFLOW_CHECKING="ON" UNDERFLOW_CHECKING="ON" aclr clock data empty full q rreq sclr usedw wreq INTENDED_DEVICE_FAMILY="Stratix IV"
//VERSION_BEGIN 18.1 cbx_altdpram 2018:09:12:13:04:24:SJ cbx_altera_counter 2018:09:12:13:04:24:SJ cbx_altera_syncram 2018:09:12:13:04:24:SJ cbx_altera_syncram_nd_impl 2018:09:12:13:04:24:SJ cbx_altsyncram 2018:09:12:13:04:24:SJ cbx_cycloneii 2018:09:12:13:04:24:SJ cbx_fifo_common 2018:09:12:13:04:24:SJ cbx_lpm_add_sub 2018:09:12:13:04:24:SJ cbx_lpm_compare 2018:09:12:13:04:24:SJ cbx_lpm_counter 2018:09:12:13:04:24:SJ cbx_lpm_decode 2018:09:12:13:04:24:SJ cbx_lpm_mux 2018:09:12:13:04:24:SJ cbx_mgl 2018:09:12:13:10:36:SJ cbx_nadder 2018:09:12:13:04:24:SJ cbx_scfifo 2018:09:12:13:04:24:SJ cbx_stratix 2018:09:12:13:04:24:SJ cbx_stratixii 2018:09:12:13:04:24:SJ cbx_stratixiii 2018:09:12:13:04:24:SJ cbx_stratixv 2018:09:12:13:04:24:SJ cbx_util_mgl 2018:09:12:13:04:24:SJ  VERSION_END


//altsyncram ADDRESS_ACLR_A="NONE" ADDRESS_ACLR_B="NONE" ADDRESS_REG_B="CLOCK1" CLOCK_ENABLE_INPUT_B="BYPASS" DEVICE_FAMILY="Stratix IV" ENABLE_ECC="FALSE" INDATA_ACLR_A="NONE" NUMWORDS_A=32768 NUMWORDS_B=32768 OPERATION_MODE="DUAL_PORT" OUTDATA_ACLR_B="NONE" OUTDATA_REG_B="CLOCK1" WIDTH_A=8 WIDTH_B=8 WIDTH_BYTEENA_A=1 WIDTH_ECCSTATUS=2 WIDTHAD_A=15 WIDTHAD_B=15 WRCONTROL_ACLR_A="NONE" address_a address_b clock0 clock1 clocken1 data_a q_b wren_a
...
module  data_fifo_sc_fifo_decode
	( 
	data,
	enable,
...
endmodule //data_fifo_sc_fifo_decode
...
`endif
	...
	assign
		...
		sel_wire = {sel[0]};
endmodule //data_fifo_sc_fifo_mux

//synthesis_resources = lut 5 ram_bits (AUTO) 262144 reg 2 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
(* ALTERA_ATTRIBUTE = {"OPTIMIZE_POWER_DURING_SYNTHESIS=NORMAL_COMPILATION"} *)
module  data_fifo_sc_fifo_altsyncram
	( 
	address_a,
	address_b,
	clock0,
...
`endif
	...
	data_fifo_sc_fifo_decode   decode2
	( 
	.data(address_a_wire[14]),
	.enable(wren_a),
	.eq(wire_decode2_eq));
	data_fifo_sc_fifo_decode   wren_decode_a
	( 
	.data(w_addr_val_a80w),
	.enable(wren_a),
	.eq(wire_wren_decode_a_eq));
	data_fifo_sc_fifo_mux   mux3
	( 
	...
	assign
		...
		w_addr_val_a80w = wren_decode_addr_sel_a,
		wren_decode_addr_sel_a = address_a_wire[14];
endmodule //data_fifo_sc_fifo_altsyncram


//lpm_compare DEVICE_FAMILY="Stratix IV" LPM_WIDTH=15 ONE_INPUT_IS_CONSTANT="YES" aeb dataa datab
...
endmodule //data_fifo_sc_fifo_cmpr


//lpm_counter DEVICE_FAMILY="Stratix IV" lpm_direction="UP" lpm_port_updown="PORT_UNUSED" lpm_width=14 aclr clock cnt_en q sclr
...
`endif
	...
	wire	[13:0]	wire_counter_reg_bit_d;
	wire	[13:0]	wire_counter_reg_bit_asdata;
	reg	[13:0]	counter_reg_bit;
	wire	[13:0]	wire_counter_reg_bit_ena;
	wire	[13:0]	wire_counter_reg_bit_sload;
...
endmodule //data_fifo_sc_fifo_cntr
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  data_fifo_sc_fifo_cntr1
	( 
	aclr,
	clock,
	cnt_en,
...
`endif
	...
	assign
		...
		updown_lsb = updown_dir,
		updown_other_bits = ((~ external_cin) | updown_dir);
endmodule //data_fifo_sc_fifo_cntr1
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  data_fifo_sc_fifo_cntr12
	( 
	aclr,
	clock,
	cnt_en,
...
`endif
	...
	assign
		...
		updown_lsb = updown_dir,
		updown_other_bits = ((~ external_cin) | updown_dir);
endmodule //data_fifo_sc_fifo_cntr12

//synthesis_resources = lut 49 ram_bits (AUTO) 262144 reg 69 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  data_fifo_sc_fifo_a_dpfifo
	( 
	aclr,
	clock,
	data,
...
`endif
	...
	wire  [13:0]   wire_rd_ptr_msb_q;
	wire  [14:0]   wire_usedw_counter_q;
	wire  [14:0]   wire_wr_ptr_q;
	wire  asynch_read_counter_enable;
	wire  empty_out;
	wire  full_out;
	wire  pulse_ram_output;
	wire  [14:0]  ram_read_address;
	wire  [14:0]  rd_ptr;
	wire  usedw_is_0;
	wire  usedw_is_1;
	wire  usedw_is_2;
	...
	data_fifo_sc_fifo_altsyncram   FIFOram
	( 
	...
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) low_addressa <= 15'b0;
		else  low_addressa <= ({15{(~ sclr)}} & (({15{asynch_read_counter_enable}} & rd_ptr) | ({15{(~ asynch_read_counter_enable)}} & low_addressa)));
	// synopsys translate_off
	initial
		rd_ptr_lsb = 0;
	// synopsys translate_on
	...
	data_fifo_sc_fifo_cmpr   almost_full_comparer
	( 
	.aeb(wire_almost_full_comparer_aeb),
	.dataa({15{1'b1}}),
	.datab(wire_usedw_counter_q));
	data_fifo_sc_fifo_cmpr   three_comparison
	( 
	.aeb(wire_three_comparison_aeb),
	.dataa(wire_usedw_counter_q),
	.datab(15'b000000000000011));
	data_fifo_sc_fifo_cntr   rd_ptr_msb
	( 
	.aclr(aclr),
	.clock(clock),
	...
	.q(wire_rd_ptr_msb_q),
	.sclr(sclr));
	data_fifo_sc_fifo_cntr1   usedw_counter
	( 
	.aclr(aclr),
	.clock(clock),
	...
	.sclr(sclr),
	.updown(valid_wreq));
	data_fifo_sc_fifo_cntr12   wr_ptr
	( 
	.aclr(aclr),
	.clock(clock),
	.cnt_en(valid_wreq),
	...
	assign
		...
		q = wire_FIFOram_q_b,
		ram_read_address = (({15{(~ asynch_read_counter_enable)}} & low_addressa) | ({15{asynch_read_counter_enable}} & rd_ptr)),
...
endmodule //data_fifo_sc_fifo_a_dpfifo

//synthesis_resources = lut 49 ram_bits (AUTO) 262144 reg 69 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  data_fifo_sc_fifo_scfifo
	( 
	aclr,
	clock,
	data,
...
`endif
	...
	data_fifo_sc_fifo_a_dpfifo   dpfifo
	( 
	.aclr(aclr),
	.clock(clock),
	.data(data),
	...
	assign
		...
		q = wire_dpfifo_q,
		usedw = wire_dpfifo_usedw;
endmodule //data_fifo_sc_fifo_scfifo
//VALID FILE
...
module data_fifo_sc_fifo (
	...
	data_fifo_sc_fifo_scfifo	data_fifo_sc_fifo_scfifo_component (
				.aclr (aclr),
				.clock (clock),
				.data (data),
				.rdreq (rdreq),
