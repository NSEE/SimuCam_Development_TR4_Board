...
#define RSTC_DEV_DCOM_CH8_RST_CTRL_MSK  (1 << 7)
#define RSTC_DEV_DCOM_CH7_RST_CTRL_MSK  (1 << 6)
#define RSTC_DEV_DCOM_CH6_RST_CTRL_MSK  (1 << 5)
#define RSTC_DEV_DCOM_CH5_RST_CTRL_MSK  (1 << 4)
#define RSTC_DEV_DCOM_CH4_RST_CTRL_MSK  (1 << 3)
#define RSTC_DEV_DCOM_CH3_RST_CTRL_MSK  (1 << 2)
