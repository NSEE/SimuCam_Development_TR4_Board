...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../MebX_Qsys_Project.sopcinfo
...
# Design Name 
# setting SOPC_NAME is MebX_Qsys_Project
SOPC_NAME := MebX_Qsys_Project
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x8121af40
SOPC_SYSID_FLAG += --sidp=0x8121af40
ELF_PATCH_FLAG  += --sidp 0x8121af40

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1717865818
SOPC_SYSID_FLAG += --timestamp=1717865818
ELF_PATCH_FLAG  += --timestamp 1717865818
