    ...
    --    O_SD_CARD_CLOCK        : out   std_logic;
     ...
     --  M2_DDR3_SA             : out   std_logic_vector(1 downto 0);
       ...
       FLASH_WE_n             : out   std_logic_vector(0 downto 0);
        ...
        HSMA_BUFFER_PWDN_N     : out   std_logic;
        HSMA_BUFFER_PEM1       : out   std_logic;
        HSMA_BUFFER_PEM0       : out   std_logic;
        -- SpaceWire A
        HSMA_LVDS_RX_SPWA_DI_P : in    std_logic;
        HSMA_LVDS_RX_SPWA_DI_N : in    std_logic;
        HSMA_LVDS_RX_SPWA_SI_P : in    std_logic;
        HSMA_LVDS_RX_SPWA_SI_N : in    std_logic;
        HSMA_LVDS_TX_SPWA_DO_P : out   std_logic;
        HSMA_LVDS_TX_SPWA_DO_N : out   std_logic;
        HSMA_LVDS_TX_SPWA_SO_P : out   std_logic;
        HSMA_LVDS_TX_SPWA_SO_N : out   std_logic;
        -- SpaceWire B
        HSMA_LVDS_RX_SPWB_DI_P : in    std_logic;
        HSMA_LVDS_RX_SPWB_DI_N : in    std_logic;
        HSMA_LVDS_RX_SPWB_SI_P : in    std_logic;
        HSMA_LVDS_RX_SPWB_SI_N : in    std_logic;
        HSMA_LVDS_TX_SPWB_DO_P : out   std_logic;
        HSMA_LVDS_TX_SPWB_DO_N : out   std_logic;
        HSMA_LVDS_TX_SPWB_SO_P : out   std_logic;
        HSMA_LVDS_TX_SPWB_SO_N : out   std_logic;
        -- SpaceWire C
        HSMA_LVDS_RX_SPWC_DI_P : in    std_logic;
        HSMA_LVDS_RX_SPWC_DI_N : in    std_logic;
        HSMA_LVDS_RX_SPWC_SI_P : in    std_logic;
        HSMA_LVDS_RX_SPWC_SI_N : in    std_logic;
        HSMA_LVDS_TX_SPWC_DO_P : out   std_logic;
        HSMA_LVDS_TX_SPWC_DO_N : out   std_logic;
        HSMA_LVDS_TX_SPWC_SO_P : out   std_logic;
        HSMA_LVDS_TX_SPWC_SO_N : out   std_logic;
        -- SpaceWire D
        HSMA_LVDS_RX_SPWD_DI_P : in    std_logic;
        HSMA_LVDS_RX_SPWD_DI_N : in    std_logic;
        HSMA_LVDS_RX_SPWD_SI_P : in    std_logic;
        HSMA_LVDS_RX_SPWD_SI_N : in    std_logic;
        HSMA_LVDS_TX_SPWD_DO_P : out   std_logic;
        HSMA_LVDS_TX_SPWD_DO_N : out   std_logic;
        HSMA_LVDS_TX_SPWD_SO_P : out   std_logic;
        HSMA_LVDS_TX_SPWD_SO_N : out   std_logic;
        -- SpaceWire E
        HSMA_LVDS_RX_SPWE_DI_P : in    std_logic;
        HSMA_LVDS_RX_SPWE_DI_N : in    std_logic;
        HSMA_LVDS_RX_SPWE_SI_P : in    std_logic;
        HSMA_LVDS_RX_SPWE_SI_N : in    std_logic;
        HSMA_LVDS_TX_SPWE_DO_P : out   std_logic;
        HSMA_LVDS_TX_SPWE_DO_N : out   std_logic;
        HSMA_LVDS_TX_SPWE_SO_P : out   std_logic;
        HSMA_LVDS_TX_SPWE_SO_N : out   std_logic;
        -- SpaceWire F
        HSMA_LVDS_RX_SPWF_DI_P : in    std_logic;
        HSMA_LVDS_RX_SPWF_DI_N : in    std_logic;
        HSMA_LVDS_RX_SPWF_SI_P : in    std_logic;
        HSMA_LVDS_RX_SPWF_SI_N : in    std_logic;
        HSMA_LVDS_TX_SPWF_DO_P : out   std_logic;
        HSMA_LVDS_TX_SPWF_DO_N : out   std_logic;
        HSMA_LVDS_TX_SPWF_SO_P : out   std_logic;
        HSMA_LVDS_TX_SPWF_SO_N : out   std_logic;
        -- SpaceWire G
        HSMA_LVDS_RX_SPWG_DI_P : in    std_logic;
        HSMA_LVDS_RX_SPWG_DI_N : in    std_logic;
        HSMA_LVDS_RX_SPWG_SI_P : in    std_logic;
        HSMA_LVDS_RX_SPWG_SI_N : in    std_logic;
        HSMA_LVDS_TX_SPWG_DO_P : out   std_logic;
        HSMA_LVDS_TX_SPWG_DO_N : out   std_logic;
        HSMA_LVDS_TX_SPWG_SO_P : out   std_logic;
        HSMA_LVDS_TX_SPWG_SO_N : out   std_logic;
        -- SpaceWire H
        HSMA_LVDS_RX_SPWH_DI_P : in    std_logic;
        HSMA_LVDS_RX_SPWH_DI_N : in    std_logic;
        HSMA_LVDS_RX_SPWH_SI_P : in    std_logic;
        HSMA_LVDS_RX_SPWH_SI_N : in    std_logic;
        HSMA_LVDS_TX_SPWH_DO_P : out   std_logic;
        HSMA_LVDS_TX_SPWH_DO_N : out   std_logic;
        HSMA_LVDS_TX_SPWH_SO_P : out   std_logic;
        HSMA_LVDS_TX_SPWH_SO_N : out   std_logic;
        -- Temperature 
...
architecture bhv of MebX_TopLevel is
    ...
    alias a_HSMA_buffers_powerdown_n is ctrl_io_lvds(2);
    alias a_HSMA_buffers_preemphasis_1 is ctrl_io_lvds(1);
    alias a_HSMA_buffers_preemphasis_0 is ctrl_io_lvds(0);
    ...
    component MebX_Qsys_Project is
        port(
            ...
            memory_mem_cke                                      : out   std_logic_vector(1 downto 0);
            memory_mem_cs_n                                     : out   std_logic_vector(1 downto 0);
            ...
            memory_mem_dq                                       : inout std_logic_vector(63 downto 0) := (others => 'X');
            memory_mem_dqs                                      : inout std_logic_vector(7 downto 0)  := (others => 'X');
            memory_mem_dqs_n                                    : inout std_logic_vector(7 downto 0)  := (others => 'X');
            memory_mem_odt                                      : out   std_logic_vector(1 downto 0);
            oct_rdn                                             : in    std_logic                     := 'X';
            oct_rup                                             : in    std_logic                     := 'X';
            --
        ...
        --
          --  dip_export                                                  => SW,
           ...
           -- m1_ddr3_memory_pll_ref_clk_clk                              => OSC_50_Bank3,
            ...
            spwc_a_lvds_spw_lvds_n_strobe_in_signal                     => HSMA_LVDS_RX_SPWA_SI_N, --                                   .spw_lvds_n_strobe_in_signal
            spwc_a_lvds_spw_lvds_p_data_out_signal                      => HSMA_LVDS_TX_SPWA_DO_P, --                                   .spw_lvds_p_data_out_signal
            spwc_a_lvds_spw_lvds_n_data_out_signal                      => HSMA_LVDS_TX_SPWA_DO_N, --                                   .spw_lvds_n_data_out_signal
            spwc_a_lvds_spw_lvds_p_strobe_out_signal                    => HSMA_LVDS_TX_SPWA_SO_P, --                                   .spw_lvds_p_strobe_out_signal
            spwc_a_lvds_spw_lvds_n_strobe_out_signal                    => HSMA_LVDS_TX_SPWA_SO_N, --                                   .spw_lvds_n_strobe_out_signal
            --
            spwc_b_lvds_spw_lvds_p_data_in_signal                       => HSMA_LVDS_RX_SPWB_DI_P, --                        spwc_b_lvds.spw_lvds_p_data_in_signal
            spwc_b_lvds_spw_lvds_n_data_in_signal                       => HSMA_LVDS_RX_SPWB_DI_N, --                                   .spw_lvds_n_data_in_signal
            spwc_b_lvds_spw_lvds_p_strobe_in_signal                     => HSMA_LVDS_RX_SPWB_SI_P, --                                   .spw_lvds_p_strobe_in_signal
            spwc_b_lvds_spw_lvds_n_strobe_in_signal                     => HSMA_LVDS_RX_SPWB_SI_N, --                                   .spw_lvds_n_strobe_in_signal
            spwc_b_lvds_spw_lvds_p_data_out_signal                      => HSMA_LVDS_TX_SPWB_DO_P, --                                   .spw_lvds_p_data_out_signal
            spwc_b_lvds_spw_lvds_n_data_out_signal                      => HSMA_LVDS_TX_SPWB_DO_N, --                                   .spw_lvds_n_data_out_signal
            spwc_b_lvds_spw_lvds_p_strobe_out_signal                    => HSMA_LVDS_TX_SPWB_SO_P, --                                   .spw_lvds_p_strobe_out_signal
            spwc_b_lvds_spw_lvds_n_strobe_out_signal                    => HSMA_LVDS_TX_SPWB_SO_N, --                                   .spw_lvds_n_strobe_out_signal
            --
            spwc_c_lvds_spw_lvds_p_data_in_signal                       => HSMA_LVDS_RX_SPWC_DI_P, --                        spwc_c_lvds.spw_lvds_p_data_in_signal
            spwc_c_lvds_spw_lvds_n_data_in_signal                       => HSMA_LVDS_RX_SPWC_DI_N, --                                   .spw_lvds_n_data_in_signal
            spwc_c_lvds_spw_lvds_p_strobe_in_signal                     => HSMA_LVDS_RX_SPWC_SI_P, --                                   .spw_lvds_p_strobe_in_signal
            spwc_c_lvds_spw_lvds_n_strobe_in_signal                     => HSMA_LVDS_RX_SPWC_SI_N, --                                   .spw_lvds_n_strobe_in_signal
            spwc_c_lvds_spw_lvds_p_data_out_signal                      => HSMA_LVDS_TX_SPWC_DO_P, --                                   .spw_lvds_p_data_out_signal
            spwc_c_lvds_spw_lvds_n_data_out_signal                      => HSMA_LVDS_TX_SPWC_DO_N, --                                   .spw_lvds_n_data_out_signal
            spwc_c_lvds_spw_lvds_p_strobe_out_signal                    => HSMA_LVDS_TX_SPWC_SO_P, --                                   .spw_lvds_p_strobe_out_signal
            spwc_c_lvds_spw_lvds_n_strobe_out_signal                    => HSMA_LVDS_TX_SPWC_SO_N, --                                   .spw_lvds_n_strobe_out_signal
            --
            spwc_d_lvds_spw_lvds_p_data_in_signal                       => HSMA_LVDS_RX_SPWD_DI_P, --                        spwc_d_lvds.spw_lvds_p_data_in_signal
            spwc_d_lvds_spw_lvds_n_data_in_signal                       => HSMA_LVDS_RX_SPWD_DI_N, --                                   .spw_lvds_n_data_in_signal
            spwc_d_lvds_spw_lvds_p_strobe_in_signal                     => HSMA_LVDS_RX_SPWD_SI_P, --                                   .spw_lvds_p_strobe_in_signal
            spwc_d_lvds_spw_lvds_n_strobe_in_signal                     => HSMA_LVDS_RX_SPWD_SI_N, --                                   .spw_lvds_n_strobe_in_signal
            spwc_d_lvds_spw_lvds_p_data_out_signal                      => HSMA_LVDS_TX_SPWD_DO_P, --                                   .spw_lvds_p_data_out_signal
            spwc_d_lvds_spw_lvds_n_data_out_signal                      => HSMA_LVDS_TX_SPWD_DO_N, --                                   .spw_lvds_n_data_out_signal
            spwc_d_lvds_spw_lvds_p_strobe_out_signal                    => HSMA_LVDS_TX_SPWD_SO_P, --                                   .spw_lvds_p_strobe_out_signal
            spwc_d_lvds_spw_lvds_n_strobe_out_signal                    => HSMA_LVDS_TX_SPWD_SO_N, --                                   .spw_lvds_n_strobe_out_signal
            --
            spwc_e_lvds_spw_lvds_p_data_in_signal                       => HSMA_LVDS_RX_SPWE_DI_P, --                        spwc_e_lvds.spw_lvds_p_data_in_signal
            spwc_e_lvds_spw_lvds_n_data_in_signal                       => HSMA_LVDS_RX_SPWE_DI_N, --                                   .spw_lvds_n_data_in_signal
            spwc_e_lvds_spw_lvds_p_strobe_in_signal                     => HSMA_LVDS_RX_SPWE_SI_P, --                                   .spw_lvds_p_strobe_in_signal
            spwc_e_lvds_spw_lvds_n_strobe_in_signal                     => HSMA_LVDS_RX_SPWE_SI_N, --                                   .spw_lvds_n_strobe_in_signal
            spwc_e_lvds_spw_lvds_p_data_out_signal                      => HSMA_LVDS_TX_SPWE_DO_P, --                                   .spw_lvds_p_data_out_signal
            spwc_e_lvds_spw_lvds_n_data_out_signal                      => HSMA_LVDS_TX_SPWE_DO_N, --                                   .spw_lvds_n_data_out_signal
            spwc_e_lvds_spw_lvds_p_strobe_out_signal                    => HSMA_LVDS_TX_SPWE_SO_P, --                                   .spw_lvds_p_strobe_out_signal
            spwc_e_lvds_spw_lvds_n_strobe_out_signal                    => HSMA_LVDS_TX_SPWE_SO_N, --                                   .spw_lvds_n_strobe_out_signal
            --
            spwc_f_lvds_spw_lvds_p_data_in_signal                       => HSMA_LVDS_RX_SPWF_DI_P, --                        spwc_f_lvds.spw_lvds_p_data_in_signal
            spwc_f_lvds_spw_lvds_n_data_in_signal                       => HSMA_LVDS_RX_SPWF_DI_N, --                                   .spw_lvds_n_data_in_signal
            spwc_f_lvds_spw_lvds_p_strobe_in_signal                     => HSMA_LVDS_RX_SPWF_SI_P, --                                   .spw_lvds_p_strobe_in_signal
            spwc_f_lvds_spw_lvds_n_strobe_in_signal                     => HSMA_LVDS_RX_SPWF_SI_N, --                                   .spw_lvds_n_strobe_in_signal
            spwc_f_lvds_spw_lvds_p_data_out_signal                      => HSMA_LVDS_TX_SPWF_DO_P, --                                   .spw_lvds_p_data_out_signal
            spwc_f_lvds_spw_lvds_n_data_out_signal                      => HSMA_LVDS_TX_SPWF_DO_N, --                                   .spw_lvds_n_data_out_signal
            spwc_f_lvds_spw_lvds_p_strobe_out_signal                    => HSMA_LVDS_TX_SPWF_SO_P, --                                   .spw_lvds_p_strobe_out_signal
            spwc_f_lvds_spw_lvds_n_strobe_out_signal                    => HSMA_LVDS_TX_SPWF_SO_N, --                                   .spw_lvds_n_strobe_out_signal
            --
            spwc_g_lvds_spw_lvds_p_data_in_signal                       => HSMA_LVDS_RX_SPWG_DI_P, --                        spwc_g_lvds.spw_lvds_p_data_in_signal
            spwc_g_lvds_spw_lvds_n_data_in_signal                       => HSMA_LVDS_RX_SPWG_DI_N, --                                   .spw_lvds_n_data_in_signal
            spwc_g_lvds_spw_lvds_p_strobe_in_signal                     => HSMA_LVDS_RX_SPWG_SI_P, --                                   .spw_lvds_p_strobe_in_signal
            spwc_g_lvds_spw_lvds_n_strobe_in_signal                     => HSMA_LVDS_RX_SPWG_SI_N, --                                   .spw_lvds_n_strobe_in_signal
            spwc_g_lvds_spw_lvds_p_data_out_signal                      => HSMA_LVDS_TX_SPWG_DO_P, --                                   .spw_lvds_p_data_out_signal
            spwc_g_lvds_spw_lvds_n_data_out_signal                      => HSMA_LVDS_TX_SPWG_DO_N, --                                   .spw_lvds_n_data_out_signal
            spwc_g_lvds_spw_lvds_p_strobe_out_signal                    => HSMA_LVDS_TX_SPWG_SO_P, --                                   .spw_lvds_p_strobe_out_signal
            spwc_g_lvds_spw_lvds_n_strobe_out_signal                    => HSMA_LVDS_TX_SPWG_SO_N, --                                   .spw_lvds_n_strobe_out_signal
            --
            spwc_h_lvds_spw_lvds_p_data_in_signal                       => HSMA_LVDS_RX_SPWH_DI_P, --                        spwc_h_lvds.spw_lvds_p_data_in_signal
            spwc_h_lvds_spw_lvds_n_data_in_signal                       => HSMA_LVDS_RX_SPWH_DI_N, --                                   .spw_lvds_n_data_in_signal
            spwc_h_lvds_spw_lvds_p_strobe_in_signal                     => HSMA_LVDS_RX_SPWH_SI_P, --                                   .spw_lvds_p_strobe_in_signal
            spwc_h_lvds_spw_lvds_n_strobe_in_signal                     => HSMA_LVDS_RX_SPWH_SI_N, --                                   .spw_lvds_n_strobe_in_signal
            spwc_h_lvds_spw_lvds_p_data_out_signal                      => HSMA_LVDS_TX_SPWH_DO_P, --                                   .spw_lvds_p_data_out_signal
            spwc_h_lvds_spw_lvds_n_data_out_signal                      => HSMA_LVDS_TX_SPWH_DO_N, --                                   .spw_lvds_n_data_out_signal
            spwc_h_lvds_spw_lvds_p_strobe_out_signal                    => HSMA_LVDS_TX_SPWH_SO_P, --                                   .spw_lvds_p_strobe_out_signal
            spwc_h_lvds_spw_lvds_n_strobe_out_signal                    => HSMA_LVDS_TX_SPWH_SO_N, --                                   .spw_lvds_n_strobe_out_signal
            --
