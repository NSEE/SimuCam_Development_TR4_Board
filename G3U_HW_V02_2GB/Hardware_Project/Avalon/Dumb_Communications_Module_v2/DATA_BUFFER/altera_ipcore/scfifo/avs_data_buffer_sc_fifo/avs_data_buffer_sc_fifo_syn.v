...
// ============================================================
// File Name: avs_data_buffer_sc_fifo.v
// Megafunction Name(s):
// 			scfifo
//
...
//scfifo ADD_RAM_OUTPUT_REGISTER="OFF" DEVICE_FAMILY="Stratix IV" LPM_NUMWORDS=512 LPM_SHOWAHEAD="OFF" LPM_WIDTH=64 LPM_WIDTHU=9 OVERFLOW_CHECKING="ON" UNDERFLOW_CHECKING="ON" USE_EAB="ON" aclr clock data empty full q rdreq sclr usedw wrreq INTENDED_DEVICE_FAMILY="Stratix IV"
...
//a_dpfifo ADD_RAM_OUTPUT_REGISTER="OFF" ALLOW_RWCYCLE_WHEN_FULL="OFF" DEVICE_FAMILY="Stratix IV" LPM_NUMWORDS=512 LPM_SHOWAHEAD="OFF" lpm_width=64 lpm_widthu=9 OVERFLOW_CHECKING="ON" UNDERFLOW_CHECKING="ON" aclr clock data empty full q rreq sclr usedw wreq INTENDED_DEVICE_FAMILY="Stratix IV"
//VERSION_BEGIN 18.1 cbx_altdpram 2018:09:12:13:04:24:SJ cbx_altera_counter 2018:09:12:13:04:24:SJ cbx_altera_syncram 2018:09:12:13:04:24:SJ cbx_altera_syncram_nd_impl 2018:09:12:13:04:24:SJ cbx_altsyncram 2018:09:12:13:04:24:SJ cbx_cycloneii 2018:09:12:13:04:24:SJ cbx_fifo_common 2018:09:12:13:04:24:SJ cbx_lpm_add_sub 2018:09:12:13:04:24:SJ cbx_lpm_compare 2018:09:12:13:04:24:SJ cbx_lpm_counter 2018:09:12:13:04:24:SJ cbx_lpm_decode 2018:09:12:13:04:24:SJ cbx_lpm_mux 2018:09:12:13:04:24:SJ cbx_mgl 2018:09:12:13:10:36:SJ cbx_nadder 2018:09:12:13:04:24:SJ cbx_scfifo 2018:09:12:13:04:24:SJ cbx_stratix 2018:09:12:13:04:24:SJ cbx_stratixii 2018:09:12:13:04:24:SJ cbx_stratixiii 2018:09:12:13:04:24:SJ cbx_stratixv 2018:09:12:13:04:24:SJ cbx_util_mgl 2018:09:12:13:04:24:SJ  VERSION_END


//a_fefifo ALLOW_RWCYCLE_WHEN_FULL="OFF" LPM_NUMWORDS=512 lpm_widthad=9 OVERFLOW_CHECKING="ON" UNDERFLOW_CHECKING="ON" aclr clock empty full rreq sclr usedw_out wreq
...
module  avs_data_buffer_sc_fifo_cntr
	( 
	aclr,
	clock,
	cnt_en,
...
endmodule //avs_data_buffer_sc_fifo_cntr

//synthesis_resources = lut 9 reg 11 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  avs_data_buffer_sc_fifo_a_fefifo
	( 
	aclr,
	clock,
	empty,
...
`endif
	...
	always @ ( posedge clock or  posedge aclr)
		...
		else  b_full <= ((b_full & (b_full ^ (sclr | rreq))) | (((~ b_full) & b_non_empty) & ((~ sclr) & ((is_almost_full8 & wreq) & (~ rreq)))));
	// synopsys translate_off
	initial
		b_non_empty = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else  b_non_empty <= (((b_full & (b_full ^ sclr)) | (((~ b_non_empty) & wreq) & (~ sclr))) | (((~ b_full) & b_non_empty) & (((~ b_full) & b_non_empty) ^ (sclr | ((is_almost_empty8 & rreq) & (~ wreq))))));
	avs_data_buffer_sc_fifo_cntr   count_usedw
	( 
	.aclr(aclr),
	.clock(clock),
...
endmodule //avs_data_buffer_sc_fifo_a_fefifo


//altsyncram ADDRESS_ACLR_A="NONE" ADDRESS_ACLR_B="NONE" ADDRESS_REG_B="CLOCK1" DEVICE_FAMILY="Stratix IV" ENABLE_ECC="FALSE" INDATA_ACLR_A="NONE" NUMWORDS_A=512 NUMWORDS_B=512 OPERATION_MODE="DUAL_PORT" OUTDATA_ACLR_B="NONE" OUTDATA_REG_B="UNREGISTERED" RDCONTROL_ACLR_B="NONE" RDCONTROL_REG_B="CLOCK0" READ_DURING_WRITE_MODE_MIXED_PORTS="DONT_CARE" WIDTH_A=64 WIDTH_B=64 WIDTH_ECCSTATUS=2 WIDTHAD_A=9 WIDTHAD_B=9 WRCONTROL_ACLR_A="NONE" address_a address_b clock0 clock1 clocken1 data_a q_b wren_a
...
module  avs_data_buffer_sc_fifo_altsyncram
	( 
	address_a,
	address_b,
	clock0,
...
`endif
	...
	defparam
		...
		ram_block1a_32.port_a_last_address = 511,
		ram_block1a_32.port_a_logical_ram_depth = 512,
		...
		ram_block1a_32.port_b_last_address = 511,
		ram_block1a_32.port_b_logical_ram_depth = 512,
	...
	defparam
		...
		ram_block1a_33.port_a_last_address = 511,
		ram_block1a_33.port_a_logical_ram_depth = 512,
		...
		ram_block1a_33.port_b_last_address = 511,
		ram_block1a_33.port_b_logical_ram_depth = 512,
	...
	defparam
		...
		ram_block1a_34.port_a_last_address = 511,
		ram_block1a_34.port_a_logical_ram_depth = 512,
		...
		ram_block1a_34.port_b_last_address = 511,
		ram_block1a_34.port_b_logical_ram_depth = 512,
	...
	defparam
		...
		ram_block1a_35.port_a_last_address = 511,
		ram_block1a_35.port_a_logical_ram_depth = 512,
		...
		ram_block1a_35.port_b_last_address = 511,
		ram_block1a_35.port_b_logical_ram_depth = 512,
	...
	defparam
		...
		ram_block1a_36.port_a_last_address = 511,
		ram_block1a_36.port_a_logical_ram_depth = 512,
		...
		ram_block1a_36.port_b_last_address = 511,
		ram_block1a_36.port_b_logical_ram_depth = 512,
	...
	defparam
		...
		ram_block1a_37.port_a_last_address = 511,
		ram_block1a_37.port_a_logical_ram_depth = 512,
		...
		ram_block1a_37.port_b_last_address = 511,
		ram_block1a_37.port_b_logical_ram_depth = 512,
	...
	defparam
		...
		ram_block1a_38.port_a_last_address = 511,
		ram_block1a_38.port_a_logical_ram_depth = 512,
		...
		ram_block1a_38.port_b_last_address = 511,
		ram_block1a_38.port_b_logical_ram_depth = 512,
	...
	defparam
		...
		ram_block1a_39.port_a_last_address = 511,
		ram_block1a_39.port_a_logical_ram_depth = 512,
		...
		ram_block1a_39.port_b_last_address = 511,
		ram_block1a_39.port_b_logical_ram_depth = 512,
	...
	defparam
		...
		ram_block1a_40.port_a_last_address = 511,
		ram_block1a_40.port_a_logical_ram_depth = 512,
		...
		ram_block1a_40.port_b_last_address = 511,
		ram_block1a_40.port_b_logical_ram_depth = 512,
	...
	defparam
		...
		ram_block1a_41.port_a_last_address = 511,
		ram_block1a_41.port_a_logical_ram_depth = 512,
		...
		ram_block1a_41.port_b_last_address = 511,
		ram_block1a_41.port_b_logical_ram_depth = 512,
	...
	defparam
		...
		ram_block1a_42.port_a_last_address = 511,
		ram_block1a_42.port_a_logical_ram_depth = 512,
		...
		ram_block1a_42.port_b_last_address = 511,
		ram_block1a_42.port_b_logical_ram_depth = 512,
	...
	defparam
		...
		ram_block1a_43.port_a_last_address = 511,
		ram_block1a_43.port_a_logical_ram_depth = 512,
		...
		ram_block1a_43.port_b_last_address = 511,
		ram_block1a_43.port_b_logical_ram_depth = 512,
	...
	defparam
		...
		ram_block1a_44.port_a_last_address = 511,
		ram_block1a_44.port_a_logical_ram_depth = 512,
		...
		ram_block1a_44.port_b_last_address = 511,
		ram_block1a_44.port_b_logical_ram_depth = 512,
	...
	defparam
		...
		ram_block1a_45.port_a_last_address = 511,
		ram_block1a_45.port_a_logical_ram_depth = 512,
		...
		ram_block1a_45.port_b_last_address = 511,
		ram_block1a_45.port_b_logical_ram_depth = 512,
	...
	defparam
		...
		ram_block1a_46.port_a_last_address = 511,
		ram_block1a_46.port_a_logical_ram_depth = 512,
		...
		ram_block1a_46.port_b_last_address = 511,
		ram_block1a_46.port_b_logical_ram_depth = 512,
	...
	defparam
		...
		ram_block1a_47.port_a_last_address = 511,
		ram_block1a_47.port_a_logical_ram_depth = 512,
		...
		ram_block1a_47.port_b_last_address = 511,
		ram_block1a_47.port_b_logical_ram_depth = 512,
	...
	defparam
		...
		ram_block1a_48.port_a_last_address = 511,
		ram_block1a_48.port_a_logical_ram_depth = 512,
		...
		ram_block1a_48.port_b_last_address = 511,
		ram_block1a_48.port_b_logical_ram_depth = 512,
	...
	defparam
		...
		ram_block1a_49.port_a_last_address = 511,
		ram_block1a_49.port_a_logical_ram_depth = 512,
		...
		ram_block1a_49.port_b_last_address = 511,
		ram_block1a_49.port_b_logical_ram_depth = 512,
	...
	defparam
		...
		ram_block1a_50.port_a_last_address = 511,
		ram_block1a_50.port_a_logical_ram_depth = 512,
		...
		ram_block1a_50.port_b_last_address = 511,
		ram_block1a_50.port_b_logical_ram_depth = 512,
	...
	defparam
		...
		ram_block1a_51.port_a_last_address = 511,
		ram_block1a_51.port_a_logical_ram_depth = 512,
		...
		ram_block1a_51.port_b_last_address = 511,
		ram_block1a_51.port_b_logical_ram_depth = 512,
	...
	defparam
		...
		ram_block1a_52.port_a_last_address = 511,
		ram_block1a_52.port_a_logical_ram_depth = 512,
		...
		ram_block1a_52.port_b_last_address = 511,
		ram_block1a_52.port_b_logical_ram_depth = 512,
	...
	defparam
		...
		ram_block1a_53.port_a_last_address = 511,
		ram_block1a_53.port_a_logical_ram_depth = 512,
		...
		ram_block1a_53.port_b_last_address = 511,
		ram_block1a_53.port_b_logical_ram_depth = 512,
	...
	defparam
		...
		ram_block1a_54.port_a_last_address = 511,
		ram_block1a_54.port_a_logical_ram_depth = 512,
		...
		ram_block1a_54.port_b_last_address = 511,
		ram_block1a_54.port_b_logical_ram_depth = 512,
	...
	defparam
		...
		ram_block1a_55.port_a_last_address = 511,
		ram_block1a_55.port_a_logical_ram_depth = 512,
		...
		ram_block1a_55.port_b_last_address = 511,
		ram_block1a_55.port_b_logical_ram_depth = 512,
	...
	defparam
		...
		ram_block1a_56.port_a_last_address = 511,
		ram_block1a_56.port_a_logical_ram_depth = 512,
		...
		ram_block1a_56.port_b_last_address = 511,
		ram_block1a_56.port_b_logical_ram_depth = 512,
	...
	defparam
		...
		ram_block1a_57.port_a_last_address = 511,
		ram_block1a_57.port_a_logical_ram_depth = 512,
		...
		ram_block1a_57.port_b_last_address = 511,
		ram_block1a_57.port_b_logical_ram_depth = 512,
	...
	defparam
		...
		ram_block1a_58.port_a_last_address = 511,
		ram_block1a_58.port_a_logical_ram_depth = 512,
		...
		ram_block1a_58.port_b_last_address = 511,
		ram_block1a_58.port_b_logical_ram_depth = 512,
	...
	defparam
		...
		ram_block1a_59.port_a_last_address = 511,
		ram_block1a_59.port_a_logical_ram_depth = 512,
		...
		ram_block1a_59.port_b_last_address = 511,
		ram_block1a_59.port_b_logical_ram_depth = 512,
	...
	defparam
		...
		ram_block1a_60.port_a_last_address = 511,
		ram_block1a_60.port_a_logical_ram_depth = 512,
		...
		ram_block1a_60.port_b_last_address = 511,
		ram_block1a_60.port_b_logical_ram_depth = 512,
	...
	defparam
		...
		ram_block1a_61.port_a_last_address = 511,
		ram_block1a_61.port_a_logical_ram_depth = 512,
		...
		ram_block1a_61.port_b_last_address = 511,
		ram_block1a_61.port_b_logical_ram_depth = 512,
	...
	defparam
		...
		ram_block1a_62.port_a_last_address = 511,
		ram_block1a_62.port_a_logical_ram_depth = 512,
		...
		ram_block1a_62.port_b_last_address = 511,
		ram_block1a_62.port_b_logical_ram_depth = 512,
	...
	defparam
		...
		ram_block1a_63.port_a_last_address = 511,
		ram_block1a_63.port_a_logical_ram_depth = 512,
		...
		ram_block1a_63.port_b_last_address = 511,
		ram_block1a_63.port_b_logical_ram_depth = 512,
...
endmodule //avs_data_buffer_sc_fifo_altsyncram
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  avs_data_buffer_sc_fifo_cntr1
	( 
	aclr,
	clock,
	cnt_en,
...
`endif
	...
	assign
		...
		updown_lsb = updown_dir,
		updown_other_bits = ((~ external_cin) | updown_dir);
endmodule //avs_data_buffer_sc_fifo_cntr1

//synthesis_resources = lut 27 ram_bits (AUTO) 32768 reg 29 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  avs_data_buffer_sc_fifo_a_dpfifo
	( 
	aclr,
	clock,
	data,
...
`endif
	...
	wire  [8:0]   wire_fifo_state_usedw_out;
	wire  [63:0]   wire_FIFOram_q_b;
	wire  [8:0]   wire_rd_ptr_count_q;
	wire  [8:0]   wire_wr_ptr_q;
	wire  [8:0]  rd_ptr;
	wire  valid_rreq;
	wire  valid_wreq;

	avs_data_buffer_sc_fifo_a_fefifo   fifo_state
	( 
	.aclr(aclr),
	.clock(clock),
	...
	.wreq(wreq));
	avs_data_buffer_sc_fifo_altsyncram   FIFOram
	( 
	.address_a(wire_wr_ptr_q),
	.address_b(({9{(~ sclr)}} & rd_ptr)),
	.clock0(clock),
	.clock1(clock),
	...
	.wren_a(valid_wreq));
	avs_data_buffer_sc_fifo_cntr1   rd_ptr_count
	( 
	.aclr(aclr),
	.clock(clock),
	.cnt_en(valid_rreq),
	...
	.sclr(sclr));
	avs_data_buffer_sc_fifo_cntr1   wr_ptr
	( 
	.aclr(aclr),
	.clock(clock),
	.cnt_en(valid_wreq),
...
endmodule //avs_data_buffer_sc_fifo_a_dpfifo

//synthesis_resources = lut 27 ram_bits (AUTO) 32768 reg 29 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  avs_data_buffer_sc_fifo_scfifo
	( 
	aclr,
	clock,
	data,
...
`endif
	...
	avs_data_buffer_sc_fifo_a_dpfifo   dpfifo
	( 
	.aclr(aclr),
	.clock(clock),
	.data(data),
	...
	assign
		...
		q = wire_dpfifo_q,
		usedw = wire_dpfifo_usedw;
endmodule //avs_data_buffer_sc_fifo_scfifo
//VALID FILE
...
`timescale 1 ps / 1 ps
// synopsys translate_on
module avs_data_buffer_sc_fifo (
	aclr,
	clock,
	data,
	rdreq,
	...
	avs_data_buffer_sc_fifo_scfifo	avs_data_buffer_sc_fifo_scfifo_component (
				.aclr (aclr),
				.clock (clock),
				.data (data),
				.rdreq (rdreq),
