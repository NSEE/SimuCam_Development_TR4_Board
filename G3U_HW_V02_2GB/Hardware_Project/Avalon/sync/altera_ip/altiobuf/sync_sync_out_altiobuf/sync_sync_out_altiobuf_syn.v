...
// ============================================================
// File Name: sync_sync_out_altiobuf.v
// Megafunction Name(s):
// 			altiobuf_out
//
...
//altiobuf_out DEVICE_FAMILY="Stratix IV" ENABLE_BUS_HOLD="FALSE" LEFT_SHIFT_SERIES_TERMINATION_CONTROL="FALSE" NUMBER_OF_CHANNELS=1 OPEN_DRAIN_OUTPUT="FALSE" PSEUDO_DIFFERENTIAL_MODE="FALSE" USE_DIFFERENTIAL_MODE="FALSE" USE_OE="FALSE" USE_TERMINATION_CONTROL="FALSE" datain dataout
...
module  sync_sync_out_altiobuf_iobuf_out
	( 
	datain,
	...
	assign
		...
		oe_w = 1'b1;
endmodule //sync_sync_out_altiobuf_iobuf_out
//VALID FILE
...
module sync_sync_out_altiobuf (
	...
	sync_sync_out_altiobuf_iobuf_out	sync_sync_out_altiobuf_iobuf_out_component (
				.datain (datain),
				.dataout (sub_wire0));
